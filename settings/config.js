module.exports = {
  ...
  embed: {
    ...
    footertext: "Coded By Vaibhav Madaan | Software Developer",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
  ...
  links: {
    ...
    DiscordServer: process.env.DiscordServer || `https://discord.gg/CE9RHn64x8`,
    VoteURL: process.env.VoteURL || `https://discord.gg/CE9RHn64x8`,
    Website: `https://everythin.me`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true,
